<?php
	...
	class conexionDB{																													// Creo una nueva clase
			...
			public function __construct() {	
				include "config.php";																			// Creo un constructor
				  $this->servidor = $servidordb;																			// Le doy los datos de acceso a la base de datos
				  $this->usuario = $usuariodb;																		// 
				  $this->contrasena = $contrasenadb;																	// 
				  $this->basededatos = $basedb;																// 
